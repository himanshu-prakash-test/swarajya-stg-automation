...
class LoginPage(BasePage):
    """Page Object for Swarajya Login and 2FA authentication for Purchase Order module."""
    ...
    def login(
        ...
        try:
            self.page.wait_for_url(
                lambda u: "tfa" in u.lower()
                or "dashboard" in u.lower()
                or "default" in u.lower()
                or "purchase" in u.lower()
                or "invoice" in u.lower(),
                timeout=10000,
            )
        except Exception:
            pass
