...
class LoginPage(BasePage):
    ...
    def login(
        ...
        try:
            self.page.wait_for_url(lambda u: "tfa" in u.lower() or "dashboard" in u.lower() or "default" in u.lower() or "consultant" in u.lower() or "finance" in u.lower(), timeout=10000)
        except Exception:
            pass
        ...
        self.wait_for_dom_ready()
        try:
            self.page.wait_for_url(lambda u: "tfa" not in u.lower() and ("dashboard" in u.lower() or "default" in u.lower() or "consultant" in u.lower() or "finance" in u.lower()), timeout=15000)
