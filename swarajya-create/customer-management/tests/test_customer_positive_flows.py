...
if not POS_TEST_CASES:
    raise RuntimeError(
        "No positive UI test cases found in Create-Customer-Management.xlsx sheet 'Positive_Tests'. "
...
class TestPositiveFlows:
    """Data-driven positive flow tests from Create-Customer-Management.xlsx."""
